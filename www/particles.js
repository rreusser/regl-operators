...
function run(regl) {
  ...
  var camera = require('@rreusser/regl-camera')(regl, {
    theta: 1.5,
    phi: 0.2,
    distance: 100,
    center: [0, 28, 0]
  ...
  var radius = 100;
  var pos = new Array(2).fill(0).map(function () {
  ...
  regl.frame(function () {
    ...
    camera(function () {
      return splat({ src: pos[1] });
    });
    ops.swap(pos);
  });
}
},{"../":5,"@rreusser/regl-camera":7,"fail-nicely":8,"regl":1}],5:[function(require,module,exports){
var map = require('./map');
...
},{"./map":6,"./particle-lookup":19,"./particles":20,"./swap":21}],6:[function(require,module,exports){
'use strict';
...
module.exports = function (opts) {
  return extendCommand({
    vert: ['precision mediump float;', 'attribute vec2 xy;', 'varying vec2 uv;', 'void main () {', '  uv = 0.5 * xy + 0.5;', '  gl_Position = vec4(xy, 0, 1);', '}'].join('\n'),
    frag: ['precision mediump float;', 'varying vec2 uv;', 'uniform sampler2D src;', 'void main () {', '  vec4 color = texture2D(src, uv);', '  gl_FragColor = vec4(uv, 0, 1);', '}'].join('\n'),
    attributes: {
      xy: [[-4, -4], [0, 4], [4, -4]]
    },
    uniforms: {
      ...
      dxy: function (ctx) {
        return [1 / ctx.viewportWidth, 1 / ctx.viewportHeight];
      }
    },
...
},{"regl-extend":2}],7:[function(require,module,exports){
...
},{"gl-mat4/identity":9,"gl-mat4/invert":10,"gl-mat4/lookAt":11,"gl-mat4/perspective":12,"mouse-change":14,"mouse-wheel":16}],8:[function(require,module,exports){
'use strict';
...
function failNicely(callback, options) {
  ...
  return function (err, data) {
    ...
    document.body.appendChild(h('div', { style: overlayStyles }, [h('div', { style: containerStyles }, [h('h1', title, { style: headingStyles }), h('p', err, { style: explanationStyles })])]));
  };
}
},{"h":13}],9:[function(require,module,exports){
...
;(function () {
  ...
  function h() {
    ...
    function item(l) {
      ...
      } else if (Array.isArray(l)) l.forEach(item);else if (l instanceof HTMLElement) e.appendChild(l);else if ('object' === typeof l) {
        for (var k in l) {
  ...
  if (typeof module === 'object') module.exports = h;else this.h = h;
})();
...
},{"mouse-event":15}],15:[function(require,module,exports){
'use strict';
...
},{"to-px":18}],17:[function(require,module,exports){
...
},{"parse-unit":17}],19:[function(require,module,exports){
'use strict';
...
module.exports = function (width, height) {
  ...
  var xy = [];
  for (var i = 0; i < n; i++) {
    xy.push([i % width / Math.max(1, width - 1), Math.floor(i / width) / Math.max(1, height - 1)]);
  }
  return xy;
};
...
module.exports = function (opts, reglParams) {
  ...
  var width = opts.width || opts.radius;
  var height = opts.height || opts.radius;
  var lookup = opts.particleLookup || createLookup(width, height);
  var pointSize = opts.pointSize || 1;
  var dimension = opts.dimension || 3;
...
},{"./color":3,"./particle-lookup":19,"regl-extend":2}],21:[function(require,module,exports){
'use strict';
